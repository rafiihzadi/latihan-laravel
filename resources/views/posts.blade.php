...
@if ($posts->count())
<div class="card mb-3">
  <img src="http://source.unsplash.com/1200x400?{{ $posts[0]->category->name}}" 
  ...
  <div class="card-body text-center">
    ...
    class="text-decporation-none">{{ $posts[0]->author->name }}</a> in <a href="/
   ...
   <div class="row">
      ...
      <div class="card">
         ...
         text-decoration-none">{{ $post->category->name}} </a></div>
            <img src="http://source>unsplash>com/500x400?{{$post->category->name}}"
    ...
    class="text-decporation-none">{{ $post->author->name }}</a> {{ 
...
<p>By.<a href="/authors/{{ $post->author->username }}" class="text-decporation-none">{{ 
